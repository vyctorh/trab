...
\centering
\subfigure[all nodes\label{pdf-per-a}]{\includegraphics[scale=.21]{IEEE-consolidados/G-todos-periodo.jpg}}

\subfigure[central nodes (12 to 23)\label{pdf-centro-per-b}]{\includegraphics[scale=.21]{IEEE-consolidados/G-centro-periodo.jpg}}
\end{minipage}
...
\begin{figure}[ht]
  \centering
  \label{pdf-app1}{\includegraphics[scale=.21]{IEEE-consolidados/G-pdf-app.jpg}} 
